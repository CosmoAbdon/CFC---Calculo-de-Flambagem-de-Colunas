 ...
 * @author cosmo
 */
public class EquacoesProjetoAco extends javax.swing.JFrame {

    /**
     * Creates new form EquacoesProjetoAco
     */
    VariavelCl vci;
    public EquacoesProjetoAco(VariavelCl vc) {
        initComponents();
        vci = vc;
    }
...
//            res =  (((1 - 0.5 * Math.pow(y/y1, 2)) * vci.getA() * Se) / ((1.666666667) + (0.375) * (y/y1) - (0.125) * Math.pow(y/y1, 3)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EquacoesProjetoAco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VariavelCl vcc = null;
                new EquacoesProjetoAco(vcc).setVisible(true);
            }
        });
    }
