 ...
 * @author cosmo
 */
public class EquacoesProjetoAdmProxAco extends javax.swing.JFrame {

    /**
     * Creates new form EquacoesProjetoAco
     */
    VariavelCl vci;
    public EquacoesProjetoAdmProxAco(VariavelCl vc) {
        initComponents();
        vci = vc;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EquacoesProjetoAdmProxAco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VariavelCl vcc = null;
                new EquacoesProjetoAdmProxAco(vcc).setVisible(true);
            }
        });
    }
