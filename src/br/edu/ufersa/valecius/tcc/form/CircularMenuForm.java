 ...
 * @author cosmo
 */
public class CircularMenuForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PERFIL CIRCULAR");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ufersa/valecius/tcc/res/Circular-Vazado.png"))); // NOI18N
    ...
    private void jb_cheiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_cheiaActionPerformed
        ...
        CircularCheioForm circularCheioForm = new CircularCheioForm();
        circularCheioForm.show();
        this.dispose();
    ...
    private void jb_vazadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_vazadoActionPerformed
        // TODO add your handling code here:
        CircularVazadoForm circularVazadoForm = new CircularVazadoForm();
        circularVazadoForm.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CircularMenuForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CircularMenuForm().setVisible(true);
            }
        });
    }
